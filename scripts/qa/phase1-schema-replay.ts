...
async function main() {
  ...
  const replayDbName = "construction_erp_v2_phase1_replay_20260804";
  ...
  console.log("=== HR PHASE 1 SCHEMA REPLAY RESULTS ===");
  ...
  mkdirSync(join(process.cwd(), "docs/qa/manifests"), { recursive: true });
  writeFileSync(
    join(process.cwd(), "docs/qa/manifests/hr-phase1-schema-replay.json"),
