...
export function WorkPicker({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-2 sm:p-4 animate-in fade-in duration-200">
              ...
              <table className="w-full text-left border-collapse">
                <thead className="sticky top-0 bg-slate-50/95 backdrop-blur z-10 border-b border-slate-200 text-[12px] uppercase text-slate-500 font-bold shadow-sm">
                  <tr>
                    ...
                    <th className="w-28 px-4 py-3 text-right">Đã duyệt</th>
...
fs.writeFileSync('src/components/reports/create-dialog/work-picker.tsx', content);
