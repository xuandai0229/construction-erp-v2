  ...
  try {
    ...
    const operations = entries.flatMap(e => {
      ...
      if (existingEntry && existingEntry.sourceType === "SITE_REPORT") {
        throw new Error("Dòng này đến từ Báo cáo Chỉ huy trưởng. Không thể sửa trực tiếp tại màn Khối lượng thực hiện. Hãy sửa báo cáo gốc hoặc tạo điều chỉnh có lý do.");
      }
