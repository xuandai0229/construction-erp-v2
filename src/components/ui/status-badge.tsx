...
export function StatusBadge({ className, variant = "neutral", size = "md", ...props }: StatusBadgeProps) {
  return (
    <span
      className={cn(
        "inline-flex max-w-full shrink-0 items-center justify-center whitespace-nowrap rounded-[var(--radius-sm)] border font-semibold leading-none tracking-[-0.01em] transition-colors",
        {
          // Sizes
