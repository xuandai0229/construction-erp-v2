      ...
      <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl border border-slate-200 overflow-hidden flex flex-col">
        ...
        <div className="bg-rose-600 px-6 py-4 flex items-center justify-between text-white shrink-0">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="text-base font-bold">Hủy bỏ đợt phân công kế hoạch</h3>
          </div>
          <button
            onClick={onClose}
            type="button"
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              rows={3}
              className="w-full text-xs p-2.5 bg-white border border-slate-300 rounded-xl focus:ring-2 focus:ring-rose-500 outline-hidden"
            />
          </div>
          ...
          <div className="pt-4 border-t border-slate-100 flex items-center justify-end gap-3 shrink-0">
            ...
            <button
              ...
              className="px-4 py-2 text-xs font-semibold text-white bg-rose-600 hover:bg-rose-700 rounded-xl shadow-xs transition flex items-center gap-1.5"
            >
              {isSubmitting && (
