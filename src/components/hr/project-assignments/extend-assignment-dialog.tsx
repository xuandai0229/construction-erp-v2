      ...
      <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl border border-slate-200 overflow-hidden flex flex-col">
        ...
        <div className="bg-sky-600 px-6 py-4 flex items-center justify-between text-white shrink-0">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="text-base font-bold">Gia hạn phân công công trình</h3>
          </div>
          <button
            onClick={onClose}
            type="button"
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="p-3.5 bg-sky-50 border border-sky-100 rounded-xl text-xs text-sky-900 space-y-1">
          ...
          <div className="pt-4 border-t border-slate-100 flex items-center justify-end gap-3 shrink-0">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="px-4 py-2 text-xs font-semibold text-white bg-sky-600 hover:bg-sky-700 rounded-xl shadow-xs transition flex items-center gap-1.5"
            >
              {isSubmitting && (
