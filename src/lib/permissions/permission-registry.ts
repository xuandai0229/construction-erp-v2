...
export const PERMISSION_REGISTRY: Record<Permission, PermissionDefinition> = {
  ...
  "settings.view": { globalRoles: COMPANY_WIDE, defaultScope: "GLOBAL", sourcePolicy: "settings-view" },
  "settings.company.view": { globalRoles: COMPANY_WIDE, defaultScope: "GLOBAL", sourcePolicy: "settings-company-view" },
  "settings.company.manage": { globalRoles: ["ADMIN", "DIRECTOR"], defaultScope: "GLOBAL", sourcePolicy: "settings-company-manage" },
  "settings.documents.view": { globalRoles: COMPANY_WIDE, defaultScope: "GLOBAL", sourcePolicy: "settings-documents-view" },
  "settings.documents.manage": { globalRoles: ["ADMIN"], defaultScope: "GLOBAL", sourcePolicy: "settings-documents-manage" },
  "settings.administration.view": { globalRoles: ["ADMIN"], defaultScope: "GLOBAL", sourcePolicy: "settings-administration-view" },
