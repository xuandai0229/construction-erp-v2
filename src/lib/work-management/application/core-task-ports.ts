...
import type { WorkManagementOutboxMessage } from "./core-task-outbox";
...
export interface CoreTaskOutboxStore { stage(messages: readonly WorkManagementOutboxMessage[]): Promise<void>; }
...
export interface CoreTaskTransactionContext { tasks: CoreTaskTransactionalRepository; effects: CoreTaskEffectStore; outbox: CoreTaskOutboxStore; idempotency: CoreTaskIdempotencyCompletionStore; }
