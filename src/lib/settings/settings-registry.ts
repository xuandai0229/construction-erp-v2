...
export const SETTINGS_REGISTRY: SettingDefinition[] = [
  ...
  },
  {
    ...
    description: "Tiền tệ dùng trong dự toán và thanh toán",
    editable: false,
    implemented: false,
    readOnlyReason: "Đã có cấu hình nhưng module nghiệp vụ chưa đọc setting này ở runtime.",
    adminOnly: true,
  ...
  },
  {
    ...
    description: "Kỳ kế toán bắt đầu từ tháng này",
    editable: false,
    implemented: false,
    readOnlyReason: "Đã có cấu hình nhưng module nghiệp vụ chưa đọc setting này ở runtime.",
    adminOnly: true,
  ...
  {
    key: "paymentTwoStepApproval",
    category: "approvals",
    label: "Thanh toán duyệt 2 bước",
    description: "Kế toán kiểm tra, Điều hành duyệt",
    editable: false,
    implemented: false,
    readOnlyReason: "Workflow thanh toán hiện tại chỉ có 1 bước duyệt hoặc đã được hardcode trong module Approvals",
    adminOnly: true,
    usedBy: [],
  },
  {
  ...
  {
    key: "contractValueThreshold",
    category: "approvals",
    label: "Ngưỡng hợp đồng duyệt cấp cao",
    description: "Hợp đồng lớn hơn mức này cần duyệt riêng",
    editable: false,
    implemented: false,
    readOnlyReason: "Đã có cấu hình nhưng module nghiệp vụ chưa đọc setting này ở runtime.",
    adminOnly: true,
